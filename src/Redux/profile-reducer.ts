    ...
    postsData: [
        {
            ...
            likesCount: 15, isLiked: false
        },
        {
            id: 2, message: 'It\'s my first post',
            likesCount: 20, isLiked: false
        },
        {
            id: 3, message: 'It\'s my second post',
            likesCount: 21, isLiked: false
        },
        {
            id: 4, message: 'It\'s my coolest post',
...
export const actions = {
    ...
    clickLikeActionCreator: (id: number, likesCount: number, isLiked: boolean) =>
        ({ type: 'PROFILE/CLICK_LIKE', id, likesCount, isLiked } as const),
